...
DST = {1: f"{OUT}/Event_Map_Level_1_Lobby_v4.pdf",
       2: f"{OUT}/Event_Map_Level_2_Trading_Floor_v4.pdf",
       3: f"{OUT}/Event_Map_Level_3_Gallery_v4.pdf"}
...
e.replace((991.5, 492.6, 1181.0, 502.4),
          "Mid-hall stair to the bridge and the Gallery · guest access", freg, 9.8, GRAY)
e.replace((991.5, 477.8, 1049.6, 490.2), "Bridge & Gallery stair", fsb, 12.4, DARK)
...
e.replace((580.1, 522.2, 657.3, 533.4), "Up to the Gallery", fsb, TSIZE, DARK, center=True)
...
e.replace((913.5, 740.7, 1124.1, 751.6),
          "level up in the Gallery — take the mid-hall stair or", freg, 10.9, DARK)
e.replace((913.5, 756.5, 1057.5, 767.3),
          "the elevators. The south-west stair is staff only.", freg, 10.9, DARK)
e.save(DST[2])
...
e.zone(145.0, 292.0, "STAFF ONLY", 9.6)      # service room off the corridor door
# sidebar
