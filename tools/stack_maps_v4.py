...
EVENT = {1: f"{SP}/Event_Map_Level_1_Lobby_v4.pdf",
         2: f"{SP}/Event_Map_Level_2_Trading_Floor_v4.pdf",
         3: f"{SP}/Event_Map_Level_3_Gallery_v4.pdf"}
...
outdoc.save(f"{SP}/Event_Maps_Stacked_Common_Frame_v4.pdf", garbage=3, deflate=True)
print("saved Event_Maps_Stacked_Common_Frame_v4.pdf")
