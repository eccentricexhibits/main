...
def render(svg_path, key):
    ...
    with sync_playwright() as p:
        ...
        # Chromium prints CSS px at 96/in, so the 1728 px sheet is 18 in at
        # scale 1 and would sit in the top-left of the 24 in page. 96/72 maps
        # the sheet's 72 pt/in coordinates onto the full page.
        pg.pdf(path=os.path.join(DIST, key + ".pdf"), width="24in", height="16in",
               print_background=True, scale=96 / 72,
