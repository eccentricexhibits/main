...
west wall  1679 × 1080   (short wall, carries the Domino screen 1653 × 630)
...
7. **How many passenger elevators reach Level 3?** Levels 1 and 2 each show
   two passenger shafts; the Level 3 core shows one (plus freight). Whether
   both lower-level elevators actually serve Level 3 is not stated on any
   drawing, so the keys now say "two locations on this level" rather than
   "serve every level" — confirm lift service with the venue.
