...
const TRANSITION = {
   ...
   */
  finish: 'settle',
  speakers: true, // set false to run the logo event with no speaker cards
  seed: 90210,
};
...
function mountTransition(stage, ambient, opts) {
  ...
  const cards = cfg.speakers
    ? mountSpeakers(stage, cfg, venue, wipeArrow, wipeAspect, portrait, t, pct, rules)
    : [];
